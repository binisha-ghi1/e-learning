...
import { Route, Routes, useLocation, useNavigate , Navigatevigate } from "react-router-dom";
...
const App = () => {
  ...
  // Logout function - Now properly logs the user out
  ...
  // Show sidebar only if user is logged in and on a dashboard page
  const showSidebar =
    [
      "/dashboard",
      "/profile",
  ...
  return (
    <div>
      ...
      <div className="flex">
        ...
        {!hideSidebarPages && showSidebar && <Sidebar onLogout={handleLogout} />}
