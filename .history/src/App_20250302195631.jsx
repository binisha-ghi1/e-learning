...
import { Route, Routes, useLocation, useNavigate, Navigate } from "react-router-dom"; // Add Navigate here
...
const App = () => {
  ...
  return (
    <div>
      ...
      <div className="flex">
        {showSidebar && <Sidebar onLogout={handleLogout} />} {/* Only show Sidebar on specific pages */}
