...
const App = () => {
  ...
  const ProtectedRoute = ({ element }) => {
    return user ? element : (
      <div className=' flex flex-col  w-fit  items-center justify-center bg-gray-200 pt-40 text-center text-3xl font-bold text-blue-950' style={{ padding: "20px", textAlign: "center" }}>
