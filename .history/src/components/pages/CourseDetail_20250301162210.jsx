  ...
  return (
    <div className="p-8 mx-auto">
     ...
     <div className='flex flex-row'>
      ...
      <div className='flex flex-row gap-1o justify-around bg-gray-100'>
      ...
      <div className="mt-6 ">
        ...
        <p className="text-xl  bg-gray-200 rounded-full w-32 text-center mt-4 font-medium pt-3 pb-3 text-gray-800">{course.category}</p>
