...
const AboutUs = () => {
  return (
    <div className='bg-gray-200 flex-wrap'>
      <div className='flex flex-col flex-wrap bg-gray-200 items-center text-center'>
        <img src={about} alt="About Us" className='w-full max-w-[800px] shadow-lg' />
        <h1 className='text-4xl text-black font-extrabold mt-[-100px]'>About Us</h1>
        <p className='text-xl text-gray-800 font-medium mt-4 max-w-3xl'>
      ...
      <div className='flex flex-row items-center justify-center mt-10 gap-8 flex-wrap'>
