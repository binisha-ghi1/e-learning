...
const MyCourses = () => {
  ...
  // Move a course to Active and update localStorage
  const handleActive = (course) => {
    // Remove from enrolledCourses and add to activeCourses
  ...
  return (
    <div className="p-8">
      ...
      <div className="mt-6 bg-gray-100 p-4 rounded-lg">
        ...
        {currentTab === 'active' && <Active activeCourses={activeCourses} handleCompleted={handleCompleted} handleUnenroll={handleUnenroll} />}
