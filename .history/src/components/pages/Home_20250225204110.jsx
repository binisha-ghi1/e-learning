    ...
    <div className="bg-gray-100">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between px-10 py-40 bg-blue-950 text-white">
        <div className="md:w-1/2">
          ...
          <NavLink to="/courses" className="mt-6 mb-10 inline-block">
      ...
      <div className="flex flex-wrap justify-center gap-10 py-10 bg-white rounded-tl-full rounded-br-full relative bottom-10">
