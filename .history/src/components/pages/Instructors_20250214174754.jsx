...
const courseList = [
  ...
  { name: "Graphic Design", instructor: "Nancy White", id: "digital-marketing" },
  { name: "Data Science", instructor: "Henry Smiths", id: "data-science" },
  { name: "MERN Stack", instructor: "Henry Smiths", id: "mern-stack" },
  { name: "MERN Stack", instructor: "Henry Smiths", id: "web-development" },
    ...
    <div className="p-8">
      ...
      <div className="flex flex-wrap justify-center gap-6">
        {instructors.map((instructor, index) => {
          ...
          const instructorId = instructor.toLowerCase().replace(/\s+/g, "-"); // Generate a proper URL-friendly ID
            ...
            <div key={index} className="bg-white shadow-lg p-6 rounded-lg w-80 flex flex-col items-center">
              ...
              <ul className="list-disc pl-5 text-left">
                {instructorCourses.map((course, i) => (
                  <li key={i}>
                    <NavLink to={`/course/${course.id}`} className="text-indigo-600 hover:underline">
                      {course.name}
                    </NavLink>
                  </li>
                ))}
