...
<button 
  ...
  >
    {showMore ? "Show Less" : "Read More"}
      ...
      <div className='flex bg-gray-200 mt-15'>
        <h1 className='pt-15 pl-5 pr-5 pb-5 text-3xl text-blue-950 font-bold'>Physical and online classes <br/>are available for enrollment.</h1>
      </div>
      </div>
      <Footer/>
    </div>
