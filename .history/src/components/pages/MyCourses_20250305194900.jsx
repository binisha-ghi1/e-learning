...
const MyCourses = () => {
  ...
  const handleActive = (course) => {
    ...
    // Store counts for MyProfile
    localStorage.setItem('enrolledCount', updatedEnrolled.length);
    localStorage.setItem('activeCount', updatedActive.length);
  };
  ...
  const handleCompleted = (course) => {
    ...
    localStorage.setItem('completedCount', updatedCompleted.length);
  };
  ...
  const handleUnenroll = (course, source) => {
    ...
    if (source === 'enrolled') {
      ...
      localStorage.setItem('enrolledCount', updatedCourses.length);
      ...
      localStorage.setItem('activeCount', updatedCourses.length);
      ...
      localStorage.setItem('completedCount', updatedCourses.length);
    }
  };
