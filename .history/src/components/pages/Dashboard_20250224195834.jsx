...
import MyProfile from '../Sidebar/MyProfile';  // Corrected import for Sidebar
import MyCourse from '../Sidebar/MyCourse';   // Adjust path similarly
import MyTasks from '../Sidebar/MyTasks';
import CourseVideos from '../Sidebar/CourseVideos';
    ...
    <div className="flex">
      ...
      <div className="flex-1 p-4">
        <Routes>
          ...
          <Route path="/resources" element={<CourseVideos />} /> {/* Corrected path to 'resources' */}
