      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        {cart.length === 0 ? (
          <div className="bg-white rounded-lg p-8 text-center ">
            <p className="text-xl text-blue-950">Cart is empty.<br/> Add some courses!</p>
            <img src={cartIcon} alt="" className=" pl-70 pb-10" />
           
            <NavLink to="/courses" className="text-blue-900 text-xl font-medium hover:underline">Browse Courses</NavLink>
          </div>
        ) : (
