      ...
      <div className="container mx-auto mt-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div>
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Hic iste quaerat distinctio! Ea nulla <br/>aspernatur sint molestiae optio, architecto, blanditiis, <br/>maxime harum nihil quis illo at eum aut.<br/> Quos, accusantium! Lorem ipsum dolor sit amet consectetur adipisicing elit. Ex facere totam ducimus sapiente quibusdam eaque corrupti velit dolorum, animi neque deserunt veritatis! Aspernatur mollitia consequuntur illo quod totam culpa harum!</p>
          </div>
          {/* Course Video */}
          <div>
