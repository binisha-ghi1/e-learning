...
const AboutUs = () => {
  return (
    <div>
      ...
      <div className='flex flex-row gap-20 ml-20 mt'>
       <img src="" alt="" className="src" />
       <div className='flex flex-col '>
        <h1>Vision</h1>
        <p>To be a global leader in e-learning, transforming lives by making<br/> education universally available, bridging the gap between knowledge and opportunity, and<br/> nurturing a community of empowered, skilled, and <br/>confident individuals.</p>
