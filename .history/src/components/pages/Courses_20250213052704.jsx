...
function Courses() {
  ...
  const courseList = [
    ...
    { name: 'MERN STACK', duration: '3 Months', price: '10,000', instructor: 'Henry Smiths', category: 'IT Courses' },
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          {filteredCourses.map((course, index) => (
            <div key={index} className="bg-white p-6 rounded-lg shadow-lg">
              ...
              <IoCartOutline className='relative top-5 '
               />
              <p className='bg-yellow-400 w-50 text-center rounded-full'>Add to Cart</p>
              <div className='mt-5 text-center hover:bg-gray-200  text-xl font-medium curser-pointer border-2 border-blue-900 text-blue-900 h-12'>
                <h1 className='pt-3'>VIEW COURSE</h1>
                </div>
