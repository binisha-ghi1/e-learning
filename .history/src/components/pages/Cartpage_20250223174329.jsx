        ...
        {cart.length === 0 ? (
          ...
          <div className="bg-white rounded-lg p-8">
            ...
            <div className="mt-6 flex justify-between items-center ">
             ...
             <p className="bg-blue-950 text-white mt-2 py-2 px-6 rounded-full">Pay Online through :</p>
              <NavLink to="/payment" className="mt-2 py-2 px-6 rounded-full">
                <img src={esewa} alt="" className="w-32" />
              </NavLink>
              <p className='bg-gray-200 text-black text-xl rounded-md mt-5 ml-5 py-4 px-6'>On Cash</p>
              </div>
            </div>
            </div>
          </div>
