...
function CourseDetail({cart, setCart, enrolledCourses , setEnrolledCourses}) {
  const { courseId } = useParams();
  const [enrolledCourses, setEnrolledCourses] = useState([]);
  console.log(courseId); 
  const [showMore, setShowMore] = useState(false);// Debugging line to check the courseId value
