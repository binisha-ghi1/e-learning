...
<button 
  ...
  >
    {showMore ? "Show Less" : "Read More"}
      ...
      <div className='flex bg-gray-200 mt-10'>
        <h1 className='mt-15 text-3xl text-blue-950 font-bold'>Physical and online classes <br/>are available for enrollment.</h1>
      </div>
      </div>
      <Footer/>
    </div>
