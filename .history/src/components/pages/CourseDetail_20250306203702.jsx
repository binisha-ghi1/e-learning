...
function CourseDetail() {
    ...
    <div className="  ">
      <div className="relative w-full">
        ...
        <div className="absolute top-0 left-0 w-full flex flex-col justify-center p-8 text-white">
          ...
          <img
    src={instructorImages[course.instructor]}
    alt={course.instructor}
    className="w-8 h-8 rounded-full" By, {course.instructor}  
  ...
  />
      ...
      {/* Course Info Section */}
      <div className=' bg-gray-100 text-4xl text-blue-950 font-extrabold pl-6 pt-6 '>
        <h1>Course Info</h1>
      </div>
      <div className="border-4  border-blue-950 bg-gray-100  mx-auto">
...
<button 
    className="text-white bg-blue-950 text-center  cursor-pointer pl-2 pr-2 pb-2 pt-2  mb-2 rounded-2xl font-semibold ml-2 mt-2"
      ...
      <div className="mt-6 ">
        ...
        <div className="mt-6 flex gap-4">
            <button
              ...
              className={`py-2 px-6 rounded-full transition duration-300 bg-blue-900 hover:bg-blue-700 text-white ${isEnrolled ? 'cursor-not-allowed ' : ''}`}
              disabled={isEnrolled}
            >
              Enroll Now
            </button>
            <button
              ...
              className={`py-2 px-6 rounded-full transition duration-300 bg-yellow-600 text-blue-950 ${isInCart ? 'cursor-not-allowed ' : ''}`}
              disabled={isInCart}
            >
              Add to cart
            </button>
