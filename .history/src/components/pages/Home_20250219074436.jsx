...
{/* Statistics Section */}
<div className="flex flex-wrap justify-center gap-10 py-10 bg-gray-200">
  {[{ img: instructors, text: "100+ Instructors" }, { img: courses, text: "500+ Courses" }, { img: certificate, text: "Free Certifications" }, { img: students, text: "1000+ Students" }].map((item, index) => (
    <div key={index} className="flex flex-col items-center bg-blue-500 text-white p-6 rounded-lg shadow-lg w-full md:w-40 hover:scale-105 transition-transform duration-200">
      <div className="flex items-center w-fit justify-center mb-3">
        <img src={item.img} alt={`Icon representing ${item.text}`} className="w-16 mr-2" />
      ...
      <div className="flex flex-col md:flex-row items-center justify-center mr-20 gap-8 px-6 py-12">
  {/* Image Section */}
  ...
  <div className="w-full md:w-1/2 grid grid-cols-1 md:grid-cols-2 gap-6">
    {[
      ...
      <div className="flex flex-wrap justify-center gap-15 pt-10 pb-8">
        {courseList.map(course => (
          <div key={course.id} className="bg-white p-6 rounded-2xl shadow-lg shadow-blue-900 flex flex-col items-center max-w-xs">
            ...
            <button
              className="mt-4 bg-yellow-400 w-full text-white py-2 px-6 rounded-lg"
