...
const instructorImages = {
  'Nancy White': require('../../assets/images/nancy-white.jpg'),
  'Henry Smiths': require('../../assets/images/henry-smiths.jpg'),
  'Jordan': require('../../assets/images/jordan.jpg'),
  'Ethan': require('../../assets/images/ethan.jpg'),
  'Charlotte': require('../../assets/images/charlotte.jpg'),
};

// Sample course list
const courseList = [
  { name: 'UI/UX Design', image: require('../../assets/images/ui-ux.png'), duration: '2.5 Months', price: '10,000', instructor: 'Nancy White', instructorImage: instructorImages['Nancy White'], category: 'Designing Courses', id: 'ui-ux' },
  { name: 'Graphic Design', image: require('../../assets/images/graphic-design.png'), duration: '2.5 Months', price: '10,000', instructor: 'Nancy White', instructorImage: instructorImages['Nancy White'], category: 'Designing Courses', id: 'graphic-design' },
  { name: 'Data Science', image: require('../../assets/images/data-science.png'), duration: '3 Months', price: '10,000', instructor: 'Henry Smiths', instructorImage: instructorImages['Henry Smiths'], category: 'IT Courses', id: 'data-science' },
  { name: 'MERN Stack', image: require('../../assets/images/mern-stack.png'), duration: '3 Months', price: '10,000', instructor: 'Henry Smiths', instructorImage: instructorImages['Henry Smiths'], category: 'IT Courses', id: 'mern-stack' },
  { name: 'Web Development', image: require('../../assets/images/web-development.png'), duration: '3 Months', price: '10,000', instructor: 'Henry Smiths', instructorImage: instructorImages['Henry Smiths'], category: 'IT Courses', id: 'web-development' },
  { name: 'Project Management', image: require('../../assets/images/project-management.png'), duration: '2.5 Months', price: '10,000', instructor: 'Jordan', instructorImage: instructorImages['Jordan'], category: 'Business Courses', id: 'project-management' },
  { name: 'Digital Marketing', image: require('../../assets/images/digital-marketing.png'), duration: '3 Months', price: '10,000', instructor: 'Nancy White', instructorImage: instructorImages['Nancy White'], category: 'Marketing Courses', id: 'digital-marketing' },
