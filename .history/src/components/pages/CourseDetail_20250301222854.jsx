...
function CourseDetail() {
  ...
  const [enrolledCourses, setEnrolledCourses , cart , setCart] = useState([]);
      ...
      <div className="mt-6 ">
        ...
        <button
          ...
          className={`py-2 px-6 rounded-full transition duration-300 ${
            isEnrolled ? "bg-gray-500 cursor-not-allowed" : "bg-blue-900 hover:bg-blue-700 text-white"
          }`}
          disabled={isEnrolled}
        >
        ...
        <button
          ...
          className={`py-2 px-6 rounded-full transition duration-300 ${
            isInCart ? "bg-gray-500 cursor-not-allowed" : "bg-green-600 hover:bg-green-500 text-white"
          }`}
          disabled={isInCart}
        >
