...
const instructorImages = {
  ...
  return (
    <div className="bg-gray-100">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between px-10 py-30 bg-blue-950 text-white">
        <div className="md:w-1/2">
          <h1 className=" ml-15 text-4xl font-extrabold leading-tight">
            Empower Your Future with New Skills <br /> - Learn Anytime, Anywhere!
          </h1>
          <p className="text-gray-300 font-mono pt-4 ml-15">
          ...
          <NavLink to="/courses" className="mt-6  ml-15 mb-20  inline-block">
      ...
      <div className="flex flex-wrap justify-center gap-15 py-10 bg-white">
