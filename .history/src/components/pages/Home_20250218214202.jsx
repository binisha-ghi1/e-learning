...
const courseList = [
  { name: 'UI/UX Design', image: require('../../assets/images/ui-ux.png'), duration: '2.5 Months', price: '10,000', instructor: 'Nancy White', instructorImage: instructorImages['Nancy White'], id: 'ui-ux' },
  { name: 'Graphic Design', image: require('../../assets/images/graphic-design.png'), duration: '2.5 Months', price: '10,000', instructor: 'Nancy White', instructorImage: instructorImages['Nancy White'], id: 'graphic-design' },
  { name: 'Data Science', image: require('../../assets/images/data-science.png'), duration: '3 Months', price: '10,000', instructor: 'Henry Smiths', instructorImage: instructorImages['Henry Smiths'], id: 'data-science' },
  { name: 'MERN Stack', image: require('../../assets/images/mern-stack.png'), duration: '3 Months', price: '10,000', instructor: 'Henry Smiths', instructorImage: instructorImages['Henry Smiths'], id: 'mern-stack' },
  { name: 'Web Development', image: require('../../assets/images/web-development.png'), duration: '3 Months', price: '10,000', instructor: 'Henry Smiths', instructorImage: instructorImages['Henry Smiths'], id: 'web-development' },
  { name: 'Project Management', image: require('../../assets/images/project-management.png'), duration: '2.5 Months', price: '10,000', instructor: 'Jordan', instructorImage: instructorImages['Jordan'], id: 'project-management' },
  { name: 'Digital Marketing', image: require('../../assets/images/digital-marketing.png'), duration: '3 Months', price: '10,000', instructor: 'Nancy White', instructorImage: instructorImages['Nancy White'], id: 'digital-marketing' },
  { name: 'Business Analytics', image: require('../../assets/images/business-analytics.png'), duration: '3 Months', price: '10,000', instructor: 'Ethan', instructorImage: instructorImages['Ethan'], id: 'business-analytics' },
  { name: 'Brand Management', image: require('../../assets/images/brand-management.png'), duration: '1.5 Month', price: 'Free', instructor: 'Charlotte', instructorImage: instructorImages['Charlotte'], id: 'brand-management' },
  { name: 'Public Speaking & Presentation', image: require('../../assets/images/public-speaking.png'), duration: '1 Month', price: 'Free', instructor: 'Jordan', instructorImage: instructorImages['Jordan'], id: 'public-speaking' },
  { name: '3D Modeling & Animation', image: require('../../assets/images/3d-modeling.png'), duration: '3 Months', price: '10,000', instructor: 'Ethan', instructorImage: instructorImages['Ethan'], id: '3d-modeling' },
];
