...
// Instructor images
import instructorImages from '../../assets/images/instructors'; // Assuming instructor images are here.
...
const courseList = [
  ...
  { name: 'Business Analytics', image: '../../assets/images/business-analytics.png', duration: '3 Months', price: '10,000', instructor: 'Ethan', instructorImage: instructorImages['Ethan'], category: 'Business Courses', id: 'business-analytics' },
  { name: 'Brand Management', image: '../../assets/images/brand-management.png', duration: '1.5 Month', price: 'Free', instructor: 'Charlotte', instructorImage: instructorImages['Charlotte'], category: 'Free Courses', id: 'brand-management' },
  { name: 'Public Speaking & Presentation', image: '../../assets/images/public-speaking.png', duration: '1 Month', price: 'Free', instructor: 'Jordan', instructorImage: instructorImages['Jordan'], category: 'Free Courses', id: 'public-speaking' },
  { name: '3D Modeling & Animation', image: '../../assets/images/3d-modeling.png', duration: '3 Months', price: '10,000', instructor: 'Ethan', instructorImage: instructorImages['Ethan'], category: 'Creative Arts Courses', id: '3d-modeling' },
];
