    ...
    <div className='flex flex-row gap-20 pt-20 bg-gray-200'>
      <div className='flex'>
        <div className='flex flex-col items-start justify-start pl-20'>
          ...
          <div className='flex flex-col bg-gray-100 text-center pt-4 pb-6 pl-4 pr-4'>
          ...
          {filteredCourses.map((course, index) => (
            <div key={index} className="bg-white p-6 rounded-lg shadow-lg flex flex-col items-center">
              ...
              <NavLink to={`/course/${course.id}`} className='mt-4 w-full'>
                <button className='text-blue-900 border-2 border-blue-900 py-2 px-6  w-full hover:bg-gray-200 transition duration-300'>
                  View Course
                </button>
              </NavLink>
            </div>
