      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        {cart.length === 0 ? (
          ...
          <div className="bg-white rounded-lg p-8">
            ...
            <div className="mt-6 flex justify-between items-center bg-">
              <div className='flex  flex-col items-start justify-start mt-20'>
                <div className='flex bg-gray-200 text-center pl-10 pr-10 pt-10 pb-10 rounded-2xl shadow-md shadow-blue-800'>
