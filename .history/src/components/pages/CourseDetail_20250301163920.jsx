...
function CourseDetail() {
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      {/* Course Banner */}
      <div className="relative w-full h-80 flex items-center justify-center bg-gradient-to-r from-blue-900 to-blue-700 text-white text-center p-8">
        <div>
          ...
          <p className="text-yellow-400 flex items-center gap-2 text-lg mt-2">
            Ratings: {course.rating} <FaStar /><FaStar /><FaStar /><FaStar />
          </p>
        </div>
      </div>
      ...
      <div className="container mx-auto p-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          {/* Course Description */}
          <div>
            <h2 className="text-2xl font-bold text-blue-900">About This Course</h2>
            <p className="mt-4 text-gray-700 leading-relaxed">{course.description}</p>
          </div>
          {/* Course Video */}
          <div>
            <h2 className="text-2xl font-bold text-blue-900">Course Video</h2>
            {videoId ? (
              <iframe
      ...
      {/* Syllabus & Category */}
      <div className="bg-white p-8 shadow-lg rounded-lg container mx-auto mt-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          {/* Syllabus */}
          <div>
            <h2 className="text-2xl font-bold text-blue-900">Syllabus</h2>
          ...
          <div>
            ...
            <p className="text-lg bg-gray-200 py-2 px-4 mt-4 rounded-lg text-gray-800 inline-block">{course.category}</p>
