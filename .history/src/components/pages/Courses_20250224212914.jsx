...
const Courses = ({ cart, setCart }) => {
  ...
  const [enrolledCourses, setEnrolledCourses] = useState([]); // Enrolled courses state
  ...
  const enrollInCourse = (course) => {
    if (!enrolledCourses.some((item) => item.id === course.id)) {
      setEnrolledCourses([...enrolledCourses, course]); // Add to enrolled courses
              ...
              filteredCourses.map((course) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="flex items-center justify-center bg-green-400 text-blue-950 py-2 px-6 rounded-full hover:bg-green-500 transition duration-300 mt-4"
                  >
                    Enroll Now
                  </button>
                  ...
                  <button
                    ...
                    className="flex items-center justify-center bg-yellow-400 text-blue-950 py-2 px-6 rounded-full hover:bg-yellow-500 transition duration-300 w-40 mt-4"
                  >
