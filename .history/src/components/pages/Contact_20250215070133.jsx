    ...
    <div className="bg-gray-200 pb-20">
      ...
      <div className="flex flex-row gap-10 mt-20 justify-center items-center text-lg font-semibold">
        {[
          ...
          <div
            key={index}
            className="bg-gray-300 flex-1 max-w-sm text-center p-6 rounded-xl border-2 border-blue-950 shadow-lg transform hover:scale-105 transition duration-300"
          >
      ...
      <div className="flex flex-row gap-10 mt-20 justify-center items-center px-10">
        ...
        <div className="flex-1 flex flex-col items-center">
          <SlLocationPin className="text-blue-950 text-5xl mb-3" />
          <h2 className="text-2xl font-bold text-blue-950 mb-4">Our Location</h2>
          <img src={map} alt="Map" className="w-full h-96 object-cover rounded-xl shadow-lg" />
        </div>

        {/* Contact Form */}
        <div className="flex-1 bg-white p-8 rounded-2xl shadow-xl transform hover:scale-[1.02] transition duration-300">
          <div className="flex flex-col items-center">
            <FaRegMessage className="text-blue-950 text-5xl mb-3" />
