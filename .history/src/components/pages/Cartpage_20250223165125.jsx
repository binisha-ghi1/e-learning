        ...
        {cart.length === 0 ? (
          ...
          <div className="bg-white rounded-lg p-8">
            ...
            <div className="mt-6 flex justify-between items-center">
              ...
              <p className="text-2xl font-semibold  text-black">Total: <br/>  <span className=' text-red-600 text-underline mb-5'>Rs. {total.toLocaleString()} </span>  </p>
              <NavLink to="/payment" className="bg-blue-950 text-white py-2 px-6 rounded-full">
                Pay Now
              </NavLink>
            </div>
            </div>
