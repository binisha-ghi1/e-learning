    ...
    <div>
      ...
      <div className='flex flex-row'>
       ...
       <div className='flex flex-col '>
        <h1>Vision</h1>
        <p>To be a global leader in e-learning, transforming lives by making<br/> education universally available, bridging the gap between knowledge and opportunity, and<br/> nurturing a community of empowered, skilled, and confident individuals.</p>
