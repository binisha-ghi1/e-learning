  ...
  >
    {showMore ? "Show Less" : "Read More"}
      ...
      <div className='flex mt-15'>
        <h1 className='pt-15 pl-5 pr-5 pb-5 text-3xl shadow-2xl shadow-blue-700 text-blue-950 font-bold'>Physical and online classes <br/>are available for enrollment.</h1>
      </div>
      </div>
      <Footer/>
    </div>
