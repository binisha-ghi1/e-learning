...
const Dashboard = () => {
  ...
  if (!user) {
    return <div className="flex flex-col items-center justify-center mt-20">
      ...
      <p className="text-xl text-blue-950 font-medium ">This is your main dashboard area where you can access all your features.</p>
      <p className="text-xl text-blue-950 font-medium ">Please Log in first to view this page.</p>
