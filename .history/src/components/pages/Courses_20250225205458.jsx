              ...
              filteredCourses.map((course) => (
                <div key={course.id} className="bg-white p-6 rounded-2xl shadow-lg shadow-blue-900 flex flex-col flex-wrap items-center">
                  ...
                  <div className='flex flex-row items-center justify-center ml-8'>
                    ...
                    <button onClick={() => toggleWishlist(course)} className="flex items-center justify-center text-blue-950 px-6 transition duration-300">
                      {wishlist.some((item) => item.id === course.id) ? <FaHeart className="text-xl text-red-500" /> : <FaRegHeart className="text-xl" />}
                    </button>
                  </div>
