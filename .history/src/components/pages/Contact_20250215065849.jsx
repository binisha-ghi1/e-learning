  ...
  return (
    <div className='bg-gray-200'>
      ...
      <div className="flex flex-row gap-20 mt-20 justify-center items-center text-lg font-semibold">
        <div className='bg-gray-300 w-52 text-center rounded-lg border-2 border-blue-950'>
        <FiPhoneCall
        className='text-center text-3xl text-blue-950'
        />
          <h1 className='text-blue-950 text-3xl pb-4'>Phone</h1>
          <p>+977 9813000012</p>
          <p>+977 9822000012</p>
        </div>
        <div className='bg-gray-300 w-52 text-center rounded-lg border-2 border-blue-950'>
        <MdOutlineMarkEmailUnread  className='text-center text-3xl text-blue-950' />
          <h1 className='text-blue-950 text-3xl pb-4'>Email</h1>
          <p>binisha@gmail.com</p>
        </div>
        <div className='bg-gray-300 w-52 text-center rounded-lg border-2 border-blue-950'>
        <SlLocationPin  className='text-center text-3xl text-blue-950' />
          <h1 className='text-blue-950 text-3xl pb-4'>Location</h1>
          <p>Koteshwor</p>
          <p>Kathmandu</p>
        </div>
      </div>
