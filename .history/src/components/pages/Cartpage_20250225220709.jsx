        ...
        {cart.length === 0 ? (
          ...
          <div className="bg-white rounded-lg p-8 shadow-xl">
            ...
            <div className="mt-8 flex flex-col items-center">
              ...
              <NavLink to="/payment" className="mt-4 py-2 px-6 bg-blue-950 text-white font-semibold rounded-full hover:bg-blue-800 transition-colors">
                <img src={esewa} alt="Esewa" className="w-32 mx-auto"/>
              </NavLink>

              <p className="text-gray-600 text-lg mt-4">Or pay on cash at the center</p>
            </div>
          </div>
        )}
      </div>
