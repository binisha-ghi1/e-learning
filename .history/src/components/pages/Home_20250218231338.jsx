...
const Home = () => {
  ...
  return (
    <div className="bg-gray-100">
      ...
      <div className='flex flex-col mt-20  mb-20 text-center'>
        <h1 className='text-3xl font-bold'>Testimonials</h1>
        <p className='pt-4 font-mono'>“Hear from our students! Discover how our courses have empowered learners to achieve their goals and unlock new opportunities. <br/>Real stories, real success!”</p>
        <div>
          <Student/>
        </div>
      </div>
