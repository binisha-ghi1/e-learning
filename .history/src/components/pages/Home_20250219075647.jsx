...
<div className="flex flex-wrap justify-center gap-10 py-10 bg-gray-200">
  ...
  <div className="w-full md:w-1/2 grid grid-cols-1 md:grid-cols-2 gap-6 ">
    {[
      ...
      <div className="flex flex-wrap justify-center gap-15 pt-10 pb-8 bg-gray-200 ">
        {courseList.map(course => (
          <div key={course.id} className="bg-white p-6 rounded-2xl shadow-lg shadow-blue-900 flex flex-col items-center max-w-xs">
            ...
            <div className="flex items-center mt-2">
              <img src={course.instructorImage} alt= {course.instructor} className="w-8 h-8 tex rounded-full mr-2" />
              <span> By,{course.instructor}</span>
            </div>
             <button 
             onClick={() => addToCart(course)}
              className='bg-yellow-400 text-blue-950 py-2 px-6 rounded-full hover:bg-yellow-500 w-full mt-4'>
