...
const AboutUs = () => {
  return (
    <div>
      ...
      <div className='flex flex-row gap-20 ml-20 mt-20'>
       <img src={learn} alt="" className="src" />
       <div className='flex flex-col '>
        <h1 className='text-4xl font-extrabold pb-4'>Vision</h1>
        <p className='font-medium'>To be a global leader in e-learning, transforming lives by making<br/> education universally available, bridging the gap between knowledge and opportunity, and<br/> nurturing a community of empowered, skilled, and <br/>confident individuals.</p>
