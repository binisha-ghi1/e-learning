  ...
  return (
    <div className="p-8 mx-auto">
     ...
     <div className='flex flex-row'>
      ...
      <div className="mt-6 ">
        <h2 className="text-3xl text-center mt-10 font-bold underline">Category</h2>
        <p className="text-xl  bg-gray-200 rounded-full w-32 text-center mt-4 font-medium pt-3 text-gray-800">{course.category}</p>
        <div className="mt-6 flex  ml-20 gap-4">
      <button 
