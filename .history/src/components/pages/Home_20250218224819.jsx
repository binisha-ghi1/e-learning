  ...
  return (
    <div className="bg-gray-100">
      ...
      <div className='flex text-center'>
        <h1>Testimonials</h1>
        <p>“Hear from our students! Discover how our courses have empowered learners to achieve their goals and unlock new opportunities. <brReal stories, real success!”</p>
        <div></div>
      </div>
      <Footer />
    </div>
