...
const Dashboard = () => {
  ...
  if (!user) {
    return <div className="flex flex-col items-center justify-center mt-20">
      <h1 className="text-2xl ctext-center">Welcome to the Dashboard</h1>
      <p className="text-xl ">This is your main dashboard area where you can access all your features.</p>
