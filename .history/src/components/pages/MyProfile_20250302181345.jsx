...
import { useUser } from '../../components/context/usercontext'; // Import to get user data
...
const MyProfile = () => {
  ...
  return (
    <>
      <div className="w-full flex justify-center bg-gray-200">
        ...
        >
          <h2 className="text-4xl font-bold mb-6 text-left md:text-center">
            Welcome back, <br /> <span className="text-blue-300">{userData.firstName || 'Name'}</span>
          </h2>
      ...
      {/* Optionally, add another section for future content */}
      <div>
