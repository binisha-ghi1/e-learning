  ...
  return (
    <div className="p-8">
      <div className="bg-white shadow-lg rounded-lg p-6 flex flex-col items-center">
        ...
        <p className=" flex flex-row pt-4 gap-1  text-2xl text-yellow-400  font-semibold"> <FaStar/> <FaStar/><FaStar/><FaStar/> <span className="text-blac">{instructor.rating} </span></p>
