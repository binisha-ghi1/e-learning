...
const Home = () => {
  return (
    <div>
      {/* Hero Section */}
      <div className='flex flex-col md:flex-row gap-10 pt-20 bg-blue-950 text-white px-6 lg:px-20'>
        ...
        <div className='flex justify-center items-center'>
          <img src={main} alt="Main" className="h-44 md:h-56 max-w-full object-contain" />
        </div>
      </div>

      {/* Stats Section */}
      <div className='flex flex-wrap justify-center gap-6 relative -top-10 bg-white p-6 rounded-tl-full rounded-br-full'>
        <div className='flex bg-blue-400 w-fit rounded-lg shadow-2xl shadow-blue-400 p-4'>
      ...
      {/* Features Section */}
      <div className='flex flex-row flex-wrap gap-10 py-12 px-6'>
        <div className='flex items-start justify-start w-full md:w-1/2'>
          <img src={second} alt="Courses" className="max-w-full h-auto" />
        </div>

        <div className='flex flex-col items-center justify-start w-full md:w-1/2 space-y-8'>
