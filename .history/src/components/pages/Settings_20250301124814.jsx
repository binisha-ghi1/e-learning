  ...
  return (
    <div className='bg-gray-50 min-h-screen flex justify-center items-center'>
      <div className='bg-white p-6 rounded-lg shadow-lg w-full max-w-2xl'>
        <h1 className='text-3xl font-semibold text-center text-gray-700 mb-6'>Account Settings</h1>
        <form onSubmit={handleSubmit} className='space-y-6'>
          ...
          <div className='flex justify-between'>
            <button type='button' className='px-6 py-3 bg-gray-200 text-gray-700 rounded-md hover:bg-gray-300 focus:outline-none'>
              Cancel
            </button>
            <button type='submit' className='px-6 py-3 bg-blue-500 text-white rounded-md hover:bg-blue-600 focus:outline-none'>
              Save Changes
            </button>
          </div>
        </form>
