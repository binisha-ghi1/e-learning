...
function CourseDetail() {
  ...
  useEffect(() => {
    console.log('Loaded course:', course); // Check if the course is correctly loaded
  }, [course]);
  ...
  useEffect(() => {
    ...
    if (cart.length > 0) {
      console.log('Cart updated:', cart); // Debug cart state update
  ...
  const handleAddToCart = () => {
    console.log('Adding to cart:', course); // Debug course added to cart
