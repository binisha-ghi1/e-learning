  ...
  return (
    <div className=''>
      ...
      <div className='flex flex-row'>
        ...
        <div className='flex flex-col pt-20 pl-10 bg-blue-950 text-white h-fit items-center-justify-center'>
        <GrBook />
        <h1>Diverse Course Options</h1>
        <p>Something for everyone,<br/> from beginners to <br/>advanced learners.</p>
        </div>
      </div>
    </div>
  )
