              ...
              filteredCourses.map((course) => (
                ...
                >
                  ...
                  <NavLink to={`/course/${course.id}`} className="mt-4 w-full">
                    <button className="text-blue-900 text-xl border-2 border-blue-900 rounded-full py-2 mb-5 ml-6 w-40 transition duration-300 hover:bg-blue-900 hover:text-white">
                      View Course
                    </button>
                  </NavLink>
                </div>
