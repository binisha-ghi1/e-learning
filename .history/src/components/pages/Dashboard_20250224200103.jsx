...
import MyProfile from "../components/pages/MyProfile"; // Example component for profile
import MyTasks from "../components/pages/MyTasks"; // Example component for tasks
import CourseVideos from "../components/pages/CourseVideos"; // Example component for videos
import Assignments from "../components/pages/Assignments"; // Example component for assignments
import Feedback from "../components/pages/Feedback"; // Example component for feedback
import Messages from "../components/pages/Messages"; // Example component for messages
import Settings from "../components/pages/Settings"; // Example component for settings
    ...
    <div className="flex">
      ...
      <div className="flex-1 p-4">
        <Routes>
          ...
          <Route path="/resou" element={<CourseVideos />} />
