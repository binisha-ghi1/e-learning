  ...
  return (
    <div className="flex h-screen">
      <div className="w-1/3 bg-gray-100 p-4 border-r">
        ...
        <p className="text-black text-xl font-bold mb-2">Instructors</p>
      ...
      <div className="flex-1 flex flex-col">
        {selectedContact ? (
          <>
            <div className="p-4 border-b text-gray-800 font-semibold flex items-center gap-3">
              <img src={selectedContact.image} alt={selectedContact.name} className="w-8 h-8 rounded-full" />
