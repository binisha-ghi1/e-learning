  ...
  return (
    <div className='bg-gray-200'>
      ...
      <div className='mt-20'>
        ...
        <h1 className=' text-center text-2xl bg-gray-200 rounded-full relative bottom-9 h-12 w-42'>Success Stories</h1>
       </div>
       <div className='flex flex-col mt-10'>
        <p className='text-'>From a small team to a global platform</p>
       </div>
