...
const Home = () => {
  return (
    <div className=''>
      {/* Hero Section */}
      <div className='flex flex-col md:flex-row gap-16 pt-20 bg-blue-950 text-white px-6 lg:px-20'>
      ...
      {/* Stats Section */}
      <div className='grid md:grid-cols-4 gap-6 relative -top-10 bg-white p-6 rounded-tl-full rounded-br-full'>
        <div className='flex bg-blue-400 w-fit rounded-lg shadow-2xl shadow-blue-400 p-4'>
          ...
          <h1 className='text-white font-bold ml-4 text-center'>
            100+ <br />Instructors
          </h1>
        </div>
        <div className='flex bg-blue-400 w-fit rounded-lg shadow-2xl shadow-blue-400 p-4'>
      ...
      {/* Features Section */}
      <div className='flex flex-col md:flex-row gap-10 py-12 px-6'>
