  ...
  return (
   ...
   .
      <div>
         ...
         <div
              className="min-w-screen flex flex-col items-center justify-center bg-cover bg-center px-6 text-white"
              style={{ backgroundImage: `url(${rec})` }}
            >
              <h2 className="text-3xl text-start font-bold mb-6">WelCome back,<br/>name</h2>
              <p>We’re excited to have you here. Dive into your learning journey and make progress <br/> toward your goals. Remember, every step counts! Check your tasks for today and <br/> continue where you left off. Let’s make this a productive session!</p>
        
        <img src={tag}  alt="" className="relative justify-end text-end bottom-60 w-42" />
      </div>
    </div>
