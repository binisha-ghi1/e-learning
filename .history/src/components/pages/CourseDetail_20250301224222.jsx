      ...
      <div className="mt-6 ">
        ...
        <div className="mt-6 flex gap-4">
            <button
              ...
              className={`py-2 px-6 rounded-full transition duration-300 bg-blue-900 hover:bg-blue-700 text-white ${isEnrolled ? 'cursor-not-allowed opacity-50' : ''}`}
              disabled={isEnrolled}
            >
              Enroll Now
            </button>
            <button
              ...
              className={`py-2 px-6 rounded-full transition duration-300 bg-yellow-600 text-blue-950 ${isInCart ? 'cursor-not-allowed opacity-50' : ''}`}
              disabled={isInCart}
            >
              Add to cart
            </button>
