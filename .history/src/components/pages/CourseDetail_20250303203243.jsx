...
function CourseDetail() {
  ...
  return (
    <div className="  ">
      ...
      <div className="border-4  border-blue-950  mx-auto mt-2">
...
<button 
    className="text-white bg-blue-950 text-center  cursor-pointer pl-2 pr-2 pb-2 pt-2 rounded-2xl font-semibold ml-2 mt-2"
