...
const Home = () => {
  ...
  return (
    <div className="bg-gray-100">
      ...
      <div className="flex flex-wrap justify-center gap-10 py-10 bg-white rounded-tl-full shadow-sm shadow-blue-950 relative bottom-45">
      ...
      <p className='text-center bg-gray-200'>ok</p>
      <p className='text-center bg-gray-200'>ok</p>
      <p className='text-center bg-gray-200'>ok</p>
      <p className='text-center bg-gray-200'>ok</p>
      <p className='text-center bg-gray-200'>ok</p><p className='text-center bg-gray-200'>ok</p><p className='text-center bg-gray-200'>ok</p><p className='text-center bg-gray-200'>ok</p><p className='text-center bg-gray-200'>ok</p>
