...
const Contact = () => {
  return (
    <div className="bg-gray-200 pb-20">
      ...
      <div className="flex flex-row gap-20 mt-40 justify-center items-center px-10">
        {/* Map Image */}
          ...
          <form className="flex flex-col gap-3">
            {["Full Name", "Email Address", "Phone Number", "Subject"].map((placeholder, i) => (
              <input
                ...
                className="p-3 border rounded-md  focus:ring-2 focus:ring-blue-500 shadow-sm transition duration-300 hover:shadow-md"
              />
            ))}
            <textarea
