...
const Home = () => {
  ...
  return (
    <div className="bg-gray-100">
      ...
      {/* Main Banner Section */}
      <div className="flex flex-col md:flex-row items-center justify-between px-6 py-20 bg-blue-950 text-white">
      ...
      {/* Info Cards Section */}
      <div className="flex flex-wrap justify-center gap-6 py-10 bg-white rounded-tl-full shadow-sm shadow-blue-950">
      ...
      {/* Features List */}
      <div className="bg-gray-200 flex flex-col md:flex-row items-center justify-center gap-8 px-6 py-12">
      ...
      {/* Course Grid */}
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10 px-6 pt-10 pb-8 bg-gray-200">
        {courseList.map((course) => (
          <div key={course.id} className="bg-white p-6 rounded-2xl shadow-lg shadow-blue-900 flex flex-col items-center max-w-xs transform transition duration-300 hover:scale-105 hover:shadow-2xl">
            ...
            <div className="mt-6 flex gap-4">
              <Button onClick={() => addToCart(course)} title="Add to Cart" />
              <Button onClick={() => addToWishlist(course)} title="Add to Wishlist" />
            </div>
          </div>
        ))}
      </div>
