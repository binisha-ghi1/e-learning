  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      ...
      <div className="relative w-full">
        <img src={star} alt="Course Banner" className="w-full rounded-lg shadow-lg" />
        <div className="absolute top-0 left-0 w-full h-full bg-black bg-opacity-50 flex flex-col justify-center p-8 rounded-lg text-white">
      ...
      {/* Course Info */}
      <div className="mt-8">
        <h2 className="text-2xl text-blue-900 font-semibold underline">Course Info</h2>
      </div>
