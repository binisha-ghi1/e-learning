        ...
        {cart.length === 0 ? (
          ...
          <div className="bg-white rounded-lg p-8">
            ...
            <div className="mt-6 flex justify-between items-center">
              <p className="text-2xl font-semibold text-blue-950">Total: Rs. {total.toLocaleString()}</p>
              <p className="bg-teal-800 text-white py-2 px-6 rounded-full">Pay On Cash</p>
              <p className="bg-teal-800 text-white py-2 px-6 rounded-full">Pay Through E-sewa</p>
              <NavLink to="/payment" className="bg-teal-800 text-white py-2 px-6 rounded-full">
                Enroll Now
              </NavLink>
            </div>
          </div>
