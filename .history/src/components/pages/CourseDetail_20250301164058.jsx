  ...
  return (
    <div className="  ">
     ...
     <div className='flex flex-row'>
      ...
      <div className="bg-wgray-100 p-8 shadow-lg rounded-lg container mx-auto mt-10">
