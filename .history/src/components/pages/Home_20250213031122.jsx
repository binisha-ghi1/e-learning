  ...
  return (
    <div>
      <div className='flex flex-row gap-60 pt-20 bg-blue-950 text-white'>
        ...
        <p className=''>Unlock your potential with our diverse courses! Learn at your own pace with expert-led <br/>lessons; and gain the skills that you need to excel in your chosen field. Start today! </p>
        <div className="mt-6  ">
                <NavLink
                 to="/courses">
