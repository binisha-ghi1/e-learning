...
const Courses = ({ cart, setCart }) => {
    ...
    export const courseList = [
        { 
            ...
            video: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ', // Example YouTube URL
            id: 'ui-ux' 
        },
        { 
            name: 'Graphic Design', 
            ...
            instructorImage: instructorImages['Nancy White'], 
            category: 'Designing Courses', 
            video: '', // No video for this course
            id: 'graphic-design' 
        },
        { 
            name: 'Data Science', 
        ...
        // Add more courses with their respective video links
    ];

    const [category, setCategory] = useState('All Courses');
    const [filteredCourses, setFilteredCourses] = useState(courseList); // ✅ Fix: Added state
