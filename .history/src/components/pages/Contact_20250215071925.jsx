    ...
    <div className="bg-gray-200 pb-20">
      ...
      <div className="flex flex-row gap-10 mt-20 justify-center items-center text-lg font-semibold">
        {[
          ...
          <div
            key={index}
            className="bg-gray-300 w-64 h-40 flex flex-col justify-center items-center text-center p-6 rounded-xl border-2 border-blue-950 shadow-2xl shadow-blue-900 animate-bounce animate-fadeIn transform hover:scale-105 transition duration-300"
          >
