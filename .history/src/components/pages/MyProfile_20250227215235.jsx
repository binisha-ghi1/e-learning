...
const MyProfile = () => {
  return (
    <>
      ...
      {/* Courses Section */}
      <div className="w-full pt-16 flex justify-center gap-16 bg-gray-200">
        <div className="flex flex-col items-center text-center pb-20 pl-8 pr-8 pt-10 bg-white">
          <PiBookOpenTextBold className="text-4xl mb-2 text-blue-500" />
          <h1 className="text-2xl font-semibold">Enrolled Courses</h1>
        </div>
        <div className="flex flex-col items-center text-center pb-20 pl-10 pr-10 pt-10 bg-white">
          <RiGraduationCapFill className="text-4xl mb-2 text-green-500" />
          <h1 className="text-2xl pt-4 font-semibold">Active Courses</h1>
        </div>
        <div className="flex flex-col items-center text-center pb-20 pl-5 pr-5 pt-10 bg-white">
          <BiSolidTrophy className="text-4xl mb-2 text-yellow-500" />
