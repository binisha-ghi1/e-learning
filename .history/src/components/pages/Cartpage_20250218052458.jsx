...
const CartPage = ({ cart, setCart }) => {
  ...
  // Calculate total price (ignoring "Free" courses)
  const total = cart.reduce((sum, item) => sum + (item.price === 'Free' ? 0 : parseFloat(item.price)), 0);
        ...
        {cart.length === 0 ? (
          ...
          <div className="bg-white rounded-lg p-8">
            ...
            <div className="mt-6 flex justify-between items-center">
              <p className="text-2xl font-semibold text-blue-950">Total: {total.toFixed(3)}</p>
