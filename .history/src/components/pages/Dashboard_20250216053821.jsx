...
import { courseList } from "./CourseDetail"; // Adjust the path as needed
            ...
            return (
              <div key={index} className="bg-white shadow-lg rounded-lg overflow-hidden">
                ...
                <div className="p-4">
                  ...
                  <Link to={`/course/${course.id}`} className="mt-4 block text-center bg-blue-500 text-white rounded py-2">
                    View Course
                  </Link>
                </div>
              </div>
