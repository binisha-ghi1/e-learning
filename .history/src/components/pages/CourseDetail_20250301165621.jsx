      ...
      <div className="container mx-auto mt-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div>
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Hic<br/> iste quaerat distinctio! Ea nulla <br/>aspernatur sint molestiae optio, architecto, blanditiis, <br/>maxime harum nihil quis illo at eum aut.<br/> Quos, accusantium!</p>
          </div>
          {/* Course Video */}
          <div>
