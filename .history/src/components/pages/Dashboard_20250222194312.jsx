...
const Dashboard = () => {
  ...
  // Manually adding some course IDs for testing
  const [enrolledCourses, setEnrolledCourses] = useState([1, 2]); // Example: Assuming course 1 and course 2 are enrolled
        ...
        {activeSection === "My Profile" && (
          ...
          >
            ...
            <p className="text-start mb-6">
              We’re excited to have you here. Dive into your learning journey and make progress toward your goals. Check your tasks for today and continue where you left off.
            </p>
            <div className="mb-6">
