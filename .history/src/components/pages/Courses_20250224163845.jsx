                ...
                >
                  ...
                  <div className="flex flex-row flex-wrap items-center justify-center ml-8 ">
                    <button
                      ...
                      className="flex flex-wrap items-center justify-center bg-yellow-400 text-blue-950 py-2 px-6 rounded-full hover:bg-yellow-500 transition duration-300 w-40 mt-4"
                    >
                    ...
                    <button
                      ...
                      className="flex flex-wrap items-center justify-center  text-blue-950  px-6 transition duration-300 "
                    >
