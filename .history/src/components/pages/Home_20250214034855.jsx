...
const Home = () => {
  return (
    <div className=''>
      ...
      <div className=' flex flex-row  relative -top-10 items-center justify-center bg-blue-950 rounded-tl-full rounded-br-full '>
      ...
      <div className='flex flex-row gap-10'>
        ...
        <BiCrown />
          ...
          <p>Access to free resources<br/> and trial courses.</p>
        </div>
        <div className='flex flex-row gap-10 justify-center items-center'>
          <div  className='flex flex-col  pl-10 bg-blue-950 text-white h-fit items-center-justify-center'>
          <TbBulb />
           <h1 className='text-xl font-bold pl-6 relative -top-6'>Flexible Learning</h1>
           <p>Access courses anytime,<br/> anywhere, at your own<br/> pace.</p>
          </div>
          <div className='flex flex-col  pl-10 bg-blue-950 text-white h-fit items-center-justify-center'>
          <MdOutlineVerified />
            <h1 className='text-xl font-bold pl-6 relative -top-8'>Certification Of <br/>Completion</h1>
            <p>Earn a certificate to <br/>showcase your skills and <br/>achievements.</p>
          </div>
        </div>
      </div>
