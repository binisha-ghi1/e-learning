...
const Home = () => {
  return (
    <div className=''>
      ...
      <div className=' flex flex-row items-center justify-center bg-white rounded-tl-full rounded-br-full '>
        <div className='flex bg-blue-400 w-fit rounded-lg shadow-2xl shadowe- ml-10 mt-10'>
