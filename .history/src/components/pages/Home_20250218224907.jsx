  ...
  return (
    <div className="bg-gray-100">
      ...
      <div className='flex flex-col mt-20 text-center'>
        ...
        <p className='text-xl font-mono'>“Hear from our students! Discover how our courses have empowered learners to achieve their goals and unlock new opportunities. <br/>Real stories, real success!”</p>
        <div></div>
      </div>
      <Footer />
    </div>
