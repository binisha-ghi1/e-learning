...
const Dashboard = () => {
  ...
  return (
    <div className="flex h-screen mt-20 rounded-3xl">
      ...
      {/* Content Area  this the profile section*/}
      <div className="flex-1 p-6 overflow-auto">
        ...
        >
          <h2 className="text-3xl font-bold mb-6">Welcome back, Name</h2>
          <p className="text-center">
            We’re excited to have you here. Dive into your learning journey and make progress
            toward your goals. Check your tasks for today and continue where you left off.
          </p>

          <img src={tag} alt="Tag" className="absolute bottom-10 right-10 w-32" />
        </div>

        {/* Active Section this is courses video sectionb */}
        <div className="mt-10">
