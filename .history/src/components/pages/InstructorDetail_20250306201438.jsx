...
function InstructorDetail() {
  ...
  return (
    <div className="p-8 ">
      <div className="bg-gray-200 shadow-lg rounded-2xl w-64 p-6 flex flex-col justify-center items-center">
        {/* Instructor Image */}
        ...
        <p className=" flex flex-row pt-4 gap-1  text-2xl text-yellow-400  font-semibold"> <FaStar/> <FaStar/><FaStar/><FaStar/> <span className="text-blue-950 ">{instructor.rating} </span></p>
