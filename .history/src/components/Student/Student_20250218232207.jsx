      ...
      <div className='text-center  '>
        <div className='flex items-center justify-center flex-row gap-12'>
            <div className='flex flex-col bg-gray-200 font-medium'>
                <img src={eye} alt="" className="relative bottom-15 w-42 text-center items-center justify-center" />
            ...
            <div className='flex flex-col bg-gray-200 font-medium'>
                <img src={ear} alt="" className="relative bottom-15 w-42 text-center items-center justify-center" />
            <div className="flex flex-row items-center justify-center pt-4 font-extrabold   text-3xl  text-yellow-400">
            <FaStar /><FaStar /><FaStar /><FaStar /><FaStar /></div>
            ...
            <div className='flex flex-col bg-gray-200 font-medium'>
                <img src={nose} alt="" className="relative bottom-15 w-42 text-center items-center justify-center" />
            <div className="flex flex-row items-center justify-center pt-4 font-extrabold   text-3xl  text-yellow-400">
                <FaStar /><FaStar /><FaStar /><FaStar /><FaStar /></div>
