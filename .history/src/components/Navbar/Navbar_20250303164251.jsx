  ...
  return (
    <div className="flex flex-row flex-wrap bg-yellow-400 text-xl sticky top-0 z-50 font-oswald py-4 px-6 items-center justify-between">
      ...
      <div className="flex flex-wrap items-center gap-6">
        ...
        <NavLink to="/about" className={({ isActive }) => isActive ? "text-blue-950 font-bold" : "hover:text-blue-950 hover:underline"}>More</NavLink>
        {/* Search Bar */}
          ...
          <div className="flex items-center gap-4">
            ...
            {user.photoURL ? (
              <img
                src={user.photoURL}
                alt="User Profile"
                className="rounded-full border-2 border-blue-950 h-10 w-10"
              />
            ) : (
