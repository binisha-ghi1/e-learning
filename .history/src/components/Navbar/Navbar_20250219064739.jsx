...
const Navbar = ({ cart, user, courses, onSearch }) => {
    ...
    <div className="flex flex-row bg-yellow-400 text-xl sticky top-0 z-50 font-oswald gap-5 py-4 px-6 items-center justify-between">
      ...
      <div className="flex items-center gap-6">
        ...
        <input
          ...
          className="px-3 py-2 border rounded-lg text-black focus:outline-none focus:ring focus:border-blue-500"
        />
      </div>
      ...
      <div className="flex items-center gap-4">
        {user ? (
          ...
          <>
            <NavLink to="/signup" className="bg-blue-950 text-white px-4 py-2 rounded-full hover:bg-blue-800">Sign Up</NavLink>
            <NavLink to="/login" className="text-blue-950 font-bold hover:text-blue-800">Login</NavLink>
          </>
        )}
