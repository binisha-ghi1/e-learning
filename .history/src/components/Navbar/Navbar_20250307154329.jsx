  ...
  <>
    ...
    <NavLink to="/signup" className="bg-white text-blue-950 px-4 py-2 rounded-full border border-blue-950 hover:bg-gray-200">Sign Up</NavLink>
      ...
      <div className="flex items-center gap-4">
        ...
        <NavLink to="/wishlist" className="text-2xl absolute -left-1 text-blue-950">
          <FaRegHeart />
          {wishlist?.length > 0 && <span className="text-sm relative -top-12 font-medium text-red-600">({wishlist.length})</span>}
        </NavLink>
