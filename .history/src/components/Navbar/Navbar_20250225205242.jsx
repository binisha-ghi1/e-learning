...
const Navbar = ({ cart, wishlist }) => {
  ...
  return (
    <div className="flex flex-row flex-wrap bg-yellow-400 text-xl sticky top-0 z-50 font-oswald gap-2 py-4 px-6 items-center justify-between">
      {/* Logo */}
      <div className="flex  flex-wrap items-center">
        <img src={logo} alt="S.T.Tech Logo" className="h-10 w-auto  animate-spin" />
      ...
      <div className="flex gap-4">
        ...
        <NavLink to="/wishlist" className="relative">
          <FaRegHeart className='text-blue-950 text-2xl' />
          {wishlist.length > 0 && (
            <span className="absolute -top-2 -right-2 bg-red-500 text-white text-xs rounded-full w-5 h-5 flex items-center justify-center">
              {wishlist.length}
            </span>
