...
const Sidebar = () => {
  ...
  return (
    <div className="sidebar bg-gray-100 p-4 w-64 h-screen border-r">
      <div className="sidebar-content">
        ...
        <div className="buttons mt-4">
          <button
            ...
            className="block p-2 mb-2 w-full text-left bg-gray-200 rounded-md hover:bg-gray-300 transition duration-200"
          ...
          <button
            ...
            className="block p-2 mb-2 w-full text-left bg-red-200 rounded-md hover:bg-red-300 transition duration-200"
            aria-label="Logout"
          >
            Logout
          </button>
