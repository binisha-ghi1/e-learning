    ...
    return (
        <div className="min-h-screen bg-gray-200 py-8">
            <div className="max-w-4xl mx-auto px-4">
                <h2 className="text-3xl font-bold text-blue-950 mb-8">Wishlist</h2>
                {wishlist.length === 0 ? (
                    <div className="bg-gray-200 rounded-lg p-8 text-center">
                        <p className="text-xl text-blue-950 pb-5">Empty Wishlist!</p>
                        <img src={emptyWishlistImg} alt="Empty Wishlist" className="mx-auto w-100 pb-5"/>
                        ...
                        <ul className="space-y-4">
                            {wishlist.map((item) => (
                                <li key={item.id} className="flex items-center justify-between">
                                    ...
                                    <button onClick={() => removeFromWishlist(item.id)} className="bg-red-500 text-white px-4 py-2 rounded-full hover:bg-red-600">
                                        Remove
                                    </button>
                                </li>
                            ))}
                            ...
                            <div className='flex flex-col items-start justify-start mt-20'>
                                <div className='flex bg-white text-center pl-10 pr-10 pt-10 pb-10 rounded-2xl shadow-md shadow-blue-800'>
                                    <p className="text-2xl font-semibold text-black">
                                        Total: <br/>  
                                        <span className='text-red-600 text-underline'>Rs. {total.toLocaleString()} </span>
                                    </p>
                                </div>
                                <p className='text-2xl mt-10'>Payment Options :</p>
                                <NavLink to="/payment" className="mt-2 py-2 px-6 rounded-full">
                                    <img src={esewa} alt="Esewa" className="w-32" />
                                </NavLink>
