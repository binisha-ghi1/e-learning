...
// Individual Dashboard Section Components
const DashboardHome = () => <div>Welcome to your Dashboard</div>;
const Courses = () => <div>Course List</div>;
const Wishlist = () => <div>Wishlist</div>;
const Tasks = () => <div>Tasks</div>;
const CourseVideos = () => <div>Course Videos</div>;
const Feedback = () => <div>Feedback</div>;
const Messages = () => <div>Messages</div>;
const Settings = () => <div>Settings</div>;

export { DashboardHome, Courses, Wishlist, Tasks, CourseVideos, Feedback, Messages, Settings };
