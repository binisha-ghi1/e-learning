      ...
      {isPopupVisible && (
        <div className="fixed inset-0  flex justify-center items-center z-50">
          <div className="bg-white p-6 rounded-lg text-center w-72 shadow-lg">
            ...
            <p className="mb-4 text-xl font-medium">Get <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS-y_0ozYrHjzmyzDdZcMHeh8OM82BIbjuTlg&s" alt="" className="src" />  on every enrolled subjects!</p>
