    ...
    <div>
      ...
      {isPopupVisible && (
        <div className="fixed inset-0 bg-opacity-25 flex justify-center items-center z-50">
          <div className="bg-white p-6 rounded-3xl text-center w-3/12 max-w-sm shadow-lg shadow-gray-400 relative">
            {/* Close cross button at the top-right corner */}
            <button
              className="absolute -top-3 right-2 text-red-600 text-4xl"
              onClick={closePopup}
            >
              &times; {/* Unicode for cross symbol */}
            </button>
            <h2 className="text-4xl font-bold mb-4 pt-8 text-blue-950 italic">January Special Offer!</h2>
            <p className="font-medium text-xl pt-2 text-gray-700">
              Get
              <img 
