    ...
    <div>
      ...
      {isPopupVisible && (
        <div className="fixed inset-0 bg-opacity-25 flex justify-center items-center z-50">
          <div className="bg-white p-6 rounded-3xl text-center w-2/5 max-w-sm shadow-3xl">
            <h2 className="text-4xl font-bold mb-4 pt-6 text-gray-800 italic">January Special Offer!</h2>
            ...
            <button
              className="bg-green-500 text-white py-2 px-4 rounded-md text-lg font-semibold hover:bg-green-400 focus:outline-none transition duration-200"
              onClick={closePopup}
            >
              Claim Offer
            </button>
