...
import { useAuth } from "../../contexts/authContext"; // Correct import path for authContext

const Login = () => {
  const { userLoggedIn } = useAuth();  // Use userLoggedIn from context
  ...
  return (
    <div className="flex h-screen items-center justify-center bg-white">
      {userLoggedIn && <Navigate to="/home" replace={true} />} {/* Redirect to /home if logged in */}
      ...
      <div className="flex w-4/5 max-w-4xl rounded-lg overflow-hidden shadow-lg shadow-gray-400">
        ...
        <div className="w-1/2 bg-white p-10 flex flex-col justify-center">
          ...
          {errorMessage && <p className="text-red-500 text-center mb-2">{errorMessage}</p>}  {/* Display error message */}
