  ...
  return (
    <div className="flex h-screen items-center justify-center bg-white">
      <div className="flex w-4/5 max-w-4xl shadow-lg rounded-lg overflow-hidden">
        ...
        >
          <img src={logo} alt="S.T. Tech Logo" className="mb-4 relative bottom-35  bg-white rounded-lg right-50" /> <p className="relative bottom-45  italic right-36">S.T. TECH</p>
