  ...
  return (
    <div className="flex h-screen items-center justify-center bg-white ">
      <div className="flex w-4/5 max-w-4xl shadow-lg rounded-lg overflow-hidden border-4 border-blue-950">
        ...
        >
          <img src={logo} alt="" className="bg-white mt-8  rounded-lg mr-4 flex flex-row  relative -top-35 left-35 justify-items-end" /> <p className=" mr-6  ml-4 relative -top-42 px-2 pl-4 italic left-46">S.T. TECH</p>
