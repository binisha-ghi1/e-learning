      ...
      <div className="flex w-4/5 max-w-4xl  rounded-lg overflow-hidden shadow-lg shadow-gray-400">
        ...
        <div className="w-1/2 bg-white p-10 flex flex-col justify-center">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col space-y-4">
            ...
            <button
              type="submit"
              className="w-full py-2 px-4 bg-yellow-600 text-blue-950 font-medium rounded-lg cursor-pointer hover:bg-yellow-700"
            >
              Log in
            </button>
            ...
            <button
              ...
              type="button"
              className="w-full flex items-center justify-center gap-2 bg-white text-black cursor-pointer font-semibold py-3 rounded-lg"
            >
