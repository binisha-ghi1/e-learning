  ...
  return (
    <div className="flex h-screen items-center justify-center w-full">
      ...
      <div className="flex w-4/5 max-w-4xl rounded-lg overflow-hidden shadow-lg shadow-gray-400">
        ...
        {/* Left Side - Form or Logged-in Message */}
        <div className="w-1/2 p-10 flex flex-col justify-center">
          {!userLoggedIn ? (
            <>
              <h2 className="text-3xl font-bold mb-6 text-center">Welcome Back!</h2>
              <img src={logo} alt="S.T. Tech Logo" className="mb-4 bg-white rounded-lg" /> 
              <p className="italic text-center">S.T. TECH</p>
              <h2 className="text-2xl font-medium text-center">Empower Your Learning Journey- <br/>Welcome to S.T. Tech! </h2>
              <img src={logsign} alt="" className="w-62 mx-auto" />
            ...
            <>
              ...
              <button
                ...
                className="w-full py-2 px-4 bg-red-600 text-white font-medium rounded-lg cursor-pointer hover:bg-red-500"
              >
                Logout
              </button>
            </>
