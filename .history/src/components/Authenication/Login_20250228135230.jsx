  ...
  return (
    <div className="flex h-screen items-center justify-center bg-white">
      <div className="flex w-4/5 max-w-4xl shadow-lg rounded-lg overflow-hidden">
        ...
        >
          <img src={logo} alt="" className=" flex flex-row  relative -top-35 left-35 justify-items-end" /> <p className=" mr-4 relative -top-42 px-2 pl-4 italic left-46">S.T. TECH</p>
