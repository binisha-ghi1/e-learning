  ...
  return (
    <div className="flex h-screen items-center justify-center bg-white ">
      <div className="flex w-4/5 max-w-4xl  rounded-lg overflow-hidden shadow-lg shadow-gray-400">
        ...
        >
          <img src={logo} alt="" className="bg-white mt-12  rounded-lg mr-4 flex flex-row  relative -top-30 left-35 justify-items-end" /> <p className=" mr-6  ml-4 relative -top-2 px-2 pl-4 italic left-46">S.T. TECH</p>
