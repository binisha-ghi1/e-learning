...
const Login = ({ setUser }) => {
  ...
  return (
    <div
      className=" mt-20  ml-20 mr-20 flex flex-col  bg-gray-200 items-center justify-center bg-cover bg-center px-6 text-white"
      style={{ backgroundImage: `url(${vector})` }}
    >
     
      <div className="flex flex-col items-center justify-center p-8 rounded-lg shadow-lg w-full max-w-sm">
