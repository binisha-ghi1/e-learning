...
const Login = ({ setUser }) => {
  ...
  return (
    <div className="flex h-screen items-center justify-center bg-white ">
      <div className="flex w-4/5 max-w-4xl shadow-lg rounded-lg overflow-hidden border-2 border-blue-950">
        {/* Left Section - Form */}
        ...
        <div
          className=" flex flex-col justify-center items-center p-10 text-white border-4 border-blue-950"
          style={{ backgroundImage: `url(${vector})`, backgroundSize: "cover", backgroundPosition: "center" }}
        >
          <img src={logo} alt="" className="bg-white mt-4  rounded-lg mr-4 flex flex-row  relative -top-35 left-35 justify-items-end" /> <p className=" mr-6  ml-4 relative -top-42 px-2 pl-4 italic left-46">S.T. TECH</p>
          <h2 className="text-2xl font-bold text-end">Empower Your Learning Journey-</h2>
          <p className="text-end mt-4">Welcome to S.T. Tech!</p>
