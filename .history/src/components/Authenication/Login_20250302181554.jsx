...
import { doSignInWithEmailAndPassword, doSigninWithGoogle } from "../../firebaseConfig/Auth"; // Correct path
import { useAuth } from "../../contexts/authContext"; // Correctly use the useAuth hook

const Login = () => {
  const { userLoggedIn, currentUser } = useAuth();  // Use userLoggedIn from context
