    ...
    <div className="flex h-screen items-center justify-center bg-white ">
      <div className="flex w-4/5 max-w-4xl shadow-lg rounded-lg overflow-hidden border-4 border-blue-950">
        ...
        >
          ...
          <h2 className="text-2xl relative   bottom-15 font-bold text-center">Empower Your Learning Journey- <br/></h2>
          <p className="text-end relative   bottom-15 mt-4">Welcome to S.T. Tech!</p>
