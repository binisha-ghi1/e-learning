...
const Footer = () => {
  return (
    <div className="text-white py-10 px-6 position" style={{ backgroundImage: `url(${navbar})`, }}>
      {/* Footer Content */}
      <div className="max-w-6xl mt-20 mx-auto grid grid-cols-1 md:grid-cols-5 gap-8">
        ...
        <div className="space-y-2">
          ...
          <p className="hover:underline pt-1">About Us</p>
        ...
        <div className="space-y-4">
          ...
          <p className="hover:underline pt-5">FAQs</p>
          <NavLink to="/contact">
