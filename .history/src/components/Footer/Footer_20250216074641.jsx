...
const Footer = () => {
  return (
    <div className="relative bg-cover bg-center text-white py-10" style={{ backgroundImage: `url(${navbar})` }}>
      {/* Overlay for better readability */}
      <div className="absolute inset-0 bg-black opacity-60"></div>

      {/* Footer Content */}
      <div className="relative z-10 max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-5 gap-8">
        {/* Brand Info */}
