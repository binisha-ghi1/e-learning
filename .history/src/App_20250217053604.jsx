...
import CartPage from './components/pages/CartPage'; // Correct import for CartPage
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path="/cart" element={<CartPage cart={cart} setCart={setCart} />} /> {/* Pass cart and setCart to CartPage */}
      </Routes>
    </div>
  );
};
