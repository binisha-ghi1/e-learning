...
import MyCourse from './components/Sidebar/MyCourse';
import MyTasks from './components/Sidebar/MyTasks';
import CourseVideos from './components/Sidebar/CourseVideos';
import Wishlist from './components/Sidebar/Wishlist'; // Make sure this is correct location
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path="/wishlist" element={<Wishlist wishlist={wishlist} setWishlist={setWishlist} />} />  {/* Fixed here */}
        ...
        <Route path="/resources" element={<CourseVideos />} /> {/* Fixed typo in 'resourses' */}
