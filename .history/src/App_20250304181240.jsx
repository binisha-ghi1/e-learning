...
const App = () => {
  ...
  // Sidebar should only be visible on the dashboard and its subpages
  const showSidebar = user && location.pathname.startsWith("/dashboard");
  ...
  return (
    <div className="flex">
      ...
      {/* Sidebar stays persistent on dashboard pages */}
