...
const App = () => {
  ...
  // Show sidebar only if user is logged in and not on the login/signup pages
  const showSidebar = user && !hideSidebarPages.includes(location.pathname);
  ...
  return (
    <div>
      ...
      />
      <div className="flex">
        {/* Ensure Sidebar is only shown on specific pages when user is logged in */}
