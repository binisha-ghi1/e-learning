...
import Wishlist from './components/pages/Wishlist';  // Add Wishlist import
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path="/wishlist" element={<Wishlist wishlist={wishlist} setWishlist={setWishlist} />} /> {/* Corrected Wishlist route */}
