...
import { Route, Routes, useLocation } from "react-router-dom"; // Use `useLocation`
import { auth } from './components/firebase/FirebaseConfig'; // Import the auth object
import Navbar from './components/Navbar/Navbar';
import Sidebar from './components/Sidebar/Sidebar'; // ✅ Only one import
...
const App = () => {
  ...
  const handleLogout = async () => {
    try {
      await auth.signOut(); // Log out the user using Firebase's signOut method
      setUser(null);
    } catch (error) {
