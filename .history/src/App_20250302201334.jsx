...
const App = () => {
  ...
  const ProtectedRoute = ({ element }) => {
    return user ? element : (
      <div className=' flex flex-col   bg-gray-200 mt-40 items-center justify-center text-center text-3xl font-bold text-blue-950' style={{ padding: "20px", textAlign: "center" }}>
