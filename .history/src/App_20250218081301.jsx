...
import Dashboard from './components/pages/Dashboard';  // Make sure Dashboard is available here
...
const App = () => {
  ...
  const [user, setUser] = useState(null); // Use user state to store user data
